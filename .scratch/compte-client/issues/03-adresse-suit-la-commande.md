...
- **Correction ultérieure :** l'affirmation ci-dessus « le lecteur existe déjà côté checkout, rien à construire » était vraie pour l'existence du code, fausse pour son exécution — voir [ticket 11](11-checkout-ignore-adresse-par-defaut.md), qui corrige un court-circuit empêchant ce code de jamais s'exécuter pour un Client de retour.
