  ...
  (
    ...
    return (
      <button
        ...
        className={clsx(
          "inline-flex gap-2 items-center justify-center rounded-md font-medium transition-[color,background-color,border-color,transform] duration-150 ease-out motion-safe:active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
    ...
    return (
      <span
        ...
        className={clsx(
          ...
          color === "orange" && "bg-khn-gold/15 text-khn-gold-dark",
