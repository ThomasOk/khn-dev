    ...
    >
      <LegalSection title="Article 1 — Champ d'application">
        <p>
          ...
          à toute commande passée sur le site kim-hi-noodle.fr par un client
          (le « Client ») auprès de CHOUR (le « Vendeur », mentions légales
          disponibles{" "}
          <LocalizedClientLink
            href="/legal-notice"
          ...
          ), pour la vente de produits alimentaires et de boissons destinés
          à être retirés sur place (click &amp; collect) au restaurant
          Kim-Hi Noodle, 652 Avenue de l&apos;Europe, 34170
          Castelnau-le-Lez.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Article 2 — Produits">
        <p>
          ...
          Les photographies illustrant les produits n&apos;ont pas de valeur
          contractuelle.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Article 3 — Compte client">
        <p>
          La commande en ligne nécessite la création d&apos;un compte
          client, avec les informations suivantes : prénom, nom, adresse
          email, numéro de téléphone. Le Client s&apos;engage à fournir des
          informations exactes et à préserver la confidentialité de son mot
          de passe. CHOUR ne pourra être tenu responsable d&apos;un accès
          non autorisé résultant d&apos;une négligence du Client.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Article 4 — Commande">
        <p>
          ...
          paiement en ligne puis retire sa commande le jour même, aux
          horaires d&apos;ouverture à emporter, sur présentation du numéro
          de commande reçu par email.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Article 6 — Paiement">
        <p>
          ...
          prestataire de paiement sécurisé (Stripe). Le règlement sur place
          peut également être effectué en espèces, par carte bancaire ou
          par titre-restaurant, selon les modalités en vigueur au
          restaurant.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Article 7 — Droit de rétractation">
        <p>
          ...
          d&apos;un remboursement ou d&apos;un échange, sauf non-conformité
          du produit remis au Client.
        </p>
      </LegalSection>

      <LegalSection title="Article 8 — Non-retrait de commande">
        <p>
          Toute commande non retirée aux horaires convenus reste due dans
          son intégralité et ne donne lieu à aucun remboursement.
        </p>
      </LegalSection>

      <LegalSection title="Article 9 — Réclamations">
        <p>
          Toute réclamation relative à la conformité d&apos;un produit doit
          être adressée à CHOUR dans un délai de 48 heures suivant le
          retrait, par email à{" "}
          <a
      ...
      <LegalSection title="Article 10 — Vente d'alcool">
        <p>
          La vente d&apos;alcool est interdite aux mineurs. CHOUR se réserve
          le droit de demander une pièce d&apos;identité lors du retrait de
          toute commande incluant une boisson alcoolisée, et de refuser la
          remise en cas de doute sur la majorité du Client.
        </p>
      </LegalSection>
